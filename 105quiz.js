...
async function populateQuiz() {
     ...
     *                                                                           *
     *****************************************************************************/
    let quizQuestions = questions.filter(question => question.quizID === 1); // Change "2" to the correct quizID, all questions for the same quiz should have the same quizID
